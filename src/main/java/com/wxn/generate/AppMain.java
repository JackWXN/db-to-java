...
public class AppMain {
	...
	private void initialize() {
		...
		this.panel.setBounds(0, 34, 576, 119);
		...
		dataUrl.setBounds(10, 12, 148, 20);
		this.panel.add(dataUrl);
		this.textDataUrl = new JTextField(url1);
		this.textDataUrl.setBounds(66, 10, 474, 20);
		...
		this.button.setBounds(325, 82, 215, 20);
		this.panel.add(this.button);
		this.label_3 = new JLabel("数据库类型");
		this.label_3.setBounds(325, 46, 87, 20);
		this.panel.add(this.label_3);
		this.comboBox = new JComboBox();
		this.comboBox.addItem("MySQL");
		this.comboBox.setBounds(400, 46, 140, 20);
...
//		panel_1.add(this.lblccxccxabc);
		...
		this.button.setBounds(360, 60, 100, 20);
...
//		panel_1.add(this.packageName2);
		...
		this.filePath.setBounds(80, 36, 263, 20);
		...
		this.chooseFilePath.setBounds(360, 35, 100, 20);
		panel_1.add(this.chooseFilePath);
		this.lblcom = new JLabel("必须填写(例:xx.xx)");
		this.lblcom.setBounds(360, 10, 200, 20);
		...
		panel_2.setBounds(1, 320, 576, 240);
		...
		this.table.setBounds(1, 27, 389, 123);
		...
		scrollPane.setBounds(0, 0, 400, 240);
		...
		this.btncontroller.setBounds(410, 10, 132, 23);
//		panel_2.add(this.btncontroller);
		this.btnservice = new JButton("生成service");
		this.btnservice.setBounds(410, 54, 132, 23);
//		panel_2.add(this.btnservice);
		...
		this.btndaoMapper.setBounds(410, 94, 132, 23);
		...
		this.panel_3.setBounds(0, 0, 576, 37);
		...
		this.lblCreateByWxn.setBounds(450, 555, 100, 33);
		...
		this.panel_4.setBounds(0, 156, 576, 37);
